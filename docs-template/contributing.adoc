...
Developers working *on* `Spline`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Spline.git
cd Spline
...
* Bugs in `Spline`: file at `hyperpolymath/Spline/issues`.
